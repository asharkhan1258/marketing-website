                        ...
                        <div className="accrodion-content">
                          <div className="text">
                            <div className="pricing-list">
                              <ul>
                                <li>
                                  <i className="fa-light fa-check"></i>10k row
                                  search results
                                </li>
                                <li>
                                  <i className="fa-light fa-check"></i>10k row
                                ...
                                <li>
                                  <i className="fa-light fa-check"></i>100
                                  domain overview PDF's
                                </li>
                                <li>
                                  <i className="fa-light fa-check"></i>6 months
                                  historical data
                                </li>
                                <li>
                                  <i className="fa-light fa-check"></i>250 sales
                                  leads & domain contacts
                                </li>
                              </ul>
                            </div>
              ...
              <div className="col-xxl-6 col-xl-6">
                ...
                >
                  <h2 className="section-title__two-title mb-10">
                    Our Business-Friendly Pricing Solutions.
                  </h2>
                  <p>
                    ### Our Business-Friendly Pricing Solutions We offer
                    flexible, transparent pricing plans tailored to suit
                    businesses of all sizes. Whether you're a startup or an
                    established brand, our cost-effective solutions ensure you
                    get the maximum value for your digital marketing investment.
                  </p>
