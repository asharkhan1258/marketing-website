                    ...
                    <div className="footer__widget footer-col-1 mb-30">
                      <div className="footer-widget__column footer-widget__about">
                        ...
                        <p className="footer-widget__about-text">
                            ...
                            At thesalepoint.com, we specialize in driving
                            business growth through cutting-edge digital
                            marketing strategies. From SEO to social media
                            management, we help brands maximize their online
                            presence and reach their full potential.
                ...
                <div className="row">
                  <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div className="copyright">
                      <p>© 2024 thesalepoint.com All Rights Reserved.</p>
                    </div>
                  </div>
                  <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
